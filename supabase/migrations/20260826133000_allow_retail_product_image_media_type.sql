-- Preserve the existing shared media contract and add the dedicated Retail product image type
-- already used by the canonical Admin Retail uploader/shared compression profile.
