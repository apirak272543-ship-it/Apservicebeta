...
assert.match(accounts, /admin-app\.js\?v=admin-source-v11/, 'Accounts route ต้อง cache-bust runtime source ล่าสุด');
...
assert.match(profile, /admin-app\.js\?v=admin-source-v11/, 'Profile route ต้อง cache-bust runtime source ล่าสุด');
