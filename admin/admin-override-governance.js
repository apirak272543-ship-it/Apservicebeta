(() => {
  ...
  function enhanceAccountModal(modal) {
    ...
    input?.addEventListener('change', () => upload(form, 'account').catch(error => M.ui.setNotice(error.message || 'อัปโหลดหลักฐานไม่สำเร็จ', 'error')));
  }
